...
public class DataSourceProxyNativeJdbcExtractorMockTest {
    ...
    public void testGetNativeStatement() throws Exception {
        ...
        Statement proxy = new JdkJdbcProxyFactory().createStatement(org, TestUtils.mockConnectionProxy("my-ds"));
    ...
    public void testGetNativePreparedStatement() throws Exception {
        ...
        PreparedStatement proxy = new JdkJdbcProxyFactory().createPreparedStatement(org, null, TestUtils.mockConnectionProxy("my-ds"));
    ...
    public void testGetNativeCallableStatement() throws Exception {
        ...
        CallableStatement proxy = new JdkJdbcProxyFactory().createCallableStatement(org, null, TestUtils.mockConnectionProxy("my-ds"));
